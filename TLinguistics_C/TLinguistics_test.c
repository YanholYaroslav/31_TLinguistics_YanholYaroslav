...
void main(void) {
	...
	while (1)
	{
		...
		else if (input_mode == 1)
		{
			...
			FILE* fout_b = fopen("Test_Bin_Output.dat", "wb, ccs=UTF-16LE");
			fwprintf(stdout, L"\n\n");
		...
		else if (input_mode == 2)
		{
			...
			InputNoun(noun8, inp_stream, "txt");
			BreakdownNoun(noun8, sylls8);

			fwprintf(stdout, L"\n\n\nTest 8 - Full test for TWord heir (TNoun for example, heirs realizations are identical)\n");
			fwprintf(stdout, L"\nFull noun output:\n");
			OutputNoun(noun8, stdout, "txt");
			fwprintf(stdout, L"\n\n");
			fwprintf(stdout, L"\Noun text field output:\n");
			OutputNounText(noun8, stdout, "txt");
			fwprintf(stdout, L"\n");
			fwprintf(stdout, L"\nBreakdown result:\n");
			OutputSyllsArray(sylls8, stdout, "txt");
			fwprintf(stdout, L"\n\n");

			fwprintf(fout_t, L"\n\n\nTest 8 - Full test for TWord heir (TNoun for example, heirs realizations are identical)\n");
			fwprintf(fout_t, L"\nFull noun output:\n");
			OutputNoun(noun8, fout_t, "txt");
			fwprintf(fout_t, L"\n\n");
			fwprintf(fout_t, L"\Noun text field output:\n");
			OutputNounText(noun8, fout_t, "txt");
			fwprintf(fout_t, L"\n");
			fwprintf(fout_t, L"\nBreakdown result:\n");
			OutputSyllsArray(sylls8, fout_t, "txt");
			fwprintf(fout_t, L"\n\n");

			OutputNoun(noun8, fout_b, "bin");
			OutputNounText(noun8, fout_b, "bin");
			OutputSyllsArray(noun8, fout_b, "bin");


			InputSyllsArray(sylls8, inp_stream, "txt");
			TNoun* noun8_2 = CombineNoun(sylls8);

			fwprintf(stdout, L"\nCombineNoun result:\n");
			OutputNounText(noun8_2, stdout, "txt");
			fwprintf(stdout, L"\n\n");

			fwprintf(fout_t, L"\nCombineNoun result:\n");
			OutputNounText(noun8_2, fout_t, "txt");
			fwprintf(fout_t, L"\n\n");

			OutputNounText(noun8_2, fout_b, "bin");


			InputNounText(noun8_2, inp_stream, "txt");
			...
			OutputNoun(noun8_2, stdout, "txt");
			fwprintf(stdout, L"\n");

			fwprintf(fout_t, L"\nFull noun output after setting properties\n");
			OutputNoun(noun8_2, fout_t, "txt");
			fwprintf(fout_t, L"\n");

			OutputNoun(noun8_2, fout_b, "bin");
			...
			InputNounByParts(noun8_2, inp_stream, "txt");

			fwprintf(stdout, L"\nThe noun output by parts:\n");
			OutputNounByParts(noun8_2, stdout, "txt");
			fwprintf(stdout, L"\n\n");

			fwprintf(fout_t, L"\nThe noun output by parts:\n");
			OutputNounByParts(noun8_2, fout_t, "txt");
			fwprintf(fout_t, L"\n\n");

			OutputNounByParts(noun8_2, fout_b, "bin");
